var VueFormulateExtended=function(t){"use strict";var e=function(t){if("string"!=typeof t)return!1;var e=t.match(r);if(!e)return!1;var i=e[1];if(!i)return!1;if(n.test(i)||o.test(i))return!0;return!1},r=/^(?:\w+:)?\/\/(\S+)$/,n=/^localhost[\:?\d]*(?:[^\:?\d]\S*)?$/,o=/^[^\s\.]+\.\S{2,}$/;for(var i="-_",s=36;s--;)i+=s.toString(36);for(s=36;s---10;)i+=s.toString(36).toUpperCase();var a=function(t){var e="";for(s=t||21;s--;)e+=i[64*Math.random()|0];return e};
/*!
